    ...
    const apiModels: ApiModel[] = [
      ...
      },
      {
        ...
        properties: {
          ...
          assignedCrew: { type: 'array', items: { type: 'string', description: 'Crew member ID' }, description: 'Assigned crew member IDs' },
          assignedVehicles: { type: 'array', items: { type: 'string', description: 'Vehicle ID' }, description: 'Assigned vehicle IDs' },
            ...
            schema: {
              ...
              properties: {
                ...
                trends: {
                  ...
                  properties: {
                    revenue: { type: 'array', items: { type: 'object', description: 'Revenue data point' } },
                    bookings: { type: 'array', items: { type: 'object', description: 'Booking data point' } },
                  },
                },
              },
            },
